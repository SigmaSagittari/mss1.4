...
inline void structure() {
    ...
    childBoardDelta = mss::ObservedBoard::update(childBoard,
                                                  std::move(childBoardDelta));
    auto childBasic = basic;
    mss::Basic::Delta childBasicDelta;
    childBasicDelta = mss::Basic::update(childBoard, childBasic, childBoardDelta,
                                         std::move(childBasicDelta));
