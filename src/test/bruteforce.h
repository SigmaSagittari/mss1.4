...
inline void bruteforce() {
    ...
    constexpr std::array<const char *, 30> rows{
        {"00012?211111012?", "0001?33?11?101??", "112222?33321013?", "2?2?1123??11223?", "?332101?4321??3?", "12?100112?11222?",
         "0111000011100011", "111000000011112?", "1?210011113?33??", "12?2122?22???6??", "0112?3?33?45????", "00024?5?32?224??",
         "0001??4?32222332", "110122213?32??10", "?11110113??22210", "223?201?22221111", "1?3?20112112?21?", "112110001?12?211",
         "0122111122322111", "12??11?22?4?201?", "?333112?44??2011", "23?21012??332211", "?23?21122211?2?1", "222?32?211232211",
         "?223??3?11??2111", "?3?????22233?11?", "???????22?211111", "???????33?311011", "????????323?101?", "????????21?21011"}};
    mss::ObservedBoard::Result board = mss::ObservedBoard::analyze(30, 16, 99);
    ...
    const mss::Structure::Result structure = mss::Structure::analyze(board, basic, shapes, workspace.structure);
    mss::ShapeSolver::Distribution::Pool distributions;
    const mss::Probability::Result probability =
        mss::Probability::analyze(board, basic, structure, shapes, distributions, workspace.probability);
    const mss::BruteForce::Config config{false, 1, mss::BruteForce::Solver::BitwiseRootParallel};
    const std::chrono::steady_clock::time_point start = std::chrono::steady_clock::now();
    const mss::BruteForce::Result result =
        mss::BruteForce::solve(board, basic, structure, shapes, config, workspace.bruteForce);
