...
struct Basic {
  ...
  public:
    ...
    static Result analyze(const ObservedBoard::Result &state, Workspace &workspace);
...
//==============================================================================
inline Basic::Result Basic::analyze(const ObservedBoard::Result &state, Basic::Workspace &workspace) {
...
inline void Basic::applyDelta(Result &result, const Delta &delta, bool reverse) {
    ...
    auto account = [&](ObservedBoard::CellId cell, Mark old, Mark now) {
