...
inline std::span<const BoxId> ShapeSolver::GraphSolver::Graph::neighbors(BoxId box) const {
...
inline std::pair<int, int> ShapeSolver::GraphSolver::orderScore(const Graph &graph, const std::vector<BoxId> &order) {
...
inline BoxId ShapeSolver::GraphSolver::farthestBox(const Graph &graph, BoxId source) {
...
inline std::vector<BoxId> ShapeSolver::GraphSolver::makeGreedyOrder(const Graph &graph, BoxId first, bool lookahead) {
    const int boxCount = graph.offsets.size() - 1;
...
inline std::vector<BoxId> ShapeSolver::GraphSolver::makeWindow3Order(const Graph &graph, std::vector<BoxId> order) {
    const int boxCount = graph.offsets.size() - 1;
...
inline std::vector<BoxId> ShapeSolver::GraphSolver::makeSAOrder(const Graph &graph, std::vector<BoxId> seed) {
    const int boxCount = graph.offsets.size() - 1;
...
inline std::vector<BoxId> ShapeSolver::GraphSolver::makeAutoOrder(const Graph &graph) {
