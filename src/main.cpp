 ...
 *
 * 数据与不变量
 * - Grid 使用 1-based 坐标和一行一列 padding；ObservedBoard::CellId 是 x*(cols+1)+y 的稠密 int 句柄。
 * - ObservedBoard::CellId/Structure::ComponentId/Structure::BoxId/Structure::ShapeId/ShapeSolver::DistributionId 只作所属 vector/pool 的下标；越界就是 bug。
